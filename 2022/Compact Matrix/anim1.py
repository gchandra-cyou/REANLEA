...
class Scene1(Scene):
    def construct(self):
        ...
        eq_1_3=MathTex("=","2",r"\cdot","1").scale(1.3).next_to(eq_1_2).set_color(REANLEA_PURPLE_LIGHTER)#.set_color_by_gradient(REANLEA_PURPLE,REANLEA_PINK_DARKER)
...
class Scene4(Scene):
    def construct(self):
        ...
        self.play(
            dt_mv_1.animate.move_to(dt_1.get_center())
        )
        self.wait()
        self.play(
...
class Scene4_3(Scene):
    def construct(self):
        ...
        # manim -sqk anim1.py Scene4_3

        # manim -pqk anim1.py Scene4_3

        # manim -pqh anim1.py Scene4_3
...
###################################################################################################################
                        ...
                        #### completed on 20th Nov,2022 | 08:15pm  ####
